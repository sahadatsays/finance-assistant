    ...
    <article class="py-16 sm:py-20">
        <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
            ...
            <header class="mt-6">
                ...
                <p class="mt-4 text-sm text-gray-500">{{ \Illuminate\Support\Carbon::parse($post['date'])->format('F j, Y') }} &middot; {{ $post['read_time'] }} read</p>
            </header>
            <div class="prose prose-gray mt-10 max-w-none">
                <p class="text-lg text-gray-600">{{ $post['excerpt'] }}</p>
                <p class="mt-6 text-gray-600">This article is part of our growing library of personal finance guides. Full content will be published soon — in the meantime, explore Finance Assistant and put these principles into practice with real budgets, goals, and reports.</p>
            </div>
